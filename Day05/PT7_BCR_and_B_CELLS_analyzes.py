...
print("\nTable images saved to Day05/ directory.") #Change the Day05/ directory to the name of the folder you are working in if you are not working in a folder named Day05
